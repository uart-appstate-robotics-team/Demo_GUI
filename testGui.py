...
class App(Frame):
    def __init__(self, master=None):
        ...
        canvasFrame.place(in_=self, anchor="se", relx=0.5, rely=0.5)
        ...
        self.retakeButton = Button(
            self, text="Retake Picture", command=self.clickRetakeButton
        )
        self.retakeButton.place(x=100, y=600)

        # Capture the Photo
        self.captureButton = Button(
            self, text="Capture Photo", command=self.capturePhoto
        )
